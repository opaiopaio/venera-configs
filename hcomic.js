class HComic extends ComicSource {
  ...
  // Update url
  url = "https://cdn.jsdelivr.net/gh/opaiopaio/venera-configs@main/hcomic.js";
    ...
    parts: [
      {
        ...
        categories: [
          {
            label: "全部",
            target: { page: "category", attributes: { category: "全部" } },
          },
          {
            label: "全彩",
            target: {
              page: "category",
              attributes: { category: "全彩", param: "全彩" },
            },
          },
          {
            label: "無修正",
            target: {
              page: "category",
              attributes: { category: "無修正", param: "無修正" },
            },
          },
          {
            label: "蘿莉",
            target: {
              page: "category",
              attributes: { category: "蘿莉", param: "蘿莉" },
            },
          },
          {
            label: "制服",
            target: {
              page: "category",
              attributes: { category: "制服", param: "制服" },
            },
          },
          {
            label: "巨乳",
            target: {
              page: "category",
              attributes: { category: "巨乳", param: "巨乳" },
            },
          },
          {
            label: "黑絲 / 白襪",
            target: {
              page: "category",
              attributes: { category: "黑絲 / 白襪", param: "黑絲 / 白襪" },
            },
          },
          {
            label: "NTR",
            target: {
              page: "category",
              attributes: { category: "NTR", param: "netorare" },
            },
          },
          {
            label: "足交 / 腳交",
            target: {
              page: "category",
              attributes: { category: "足交 / 腳交", param: "footjob" },
            },
          },
          {
            label: "女學生",
            target: {
              page: "category",
              attributes: { category: "女學生", param: "女學生" },
            },
          },
          {
            label: "眼鏡控",
            target: {
              page: "category",
              attributes: { category: "眼鏡控", param: "眼鏡控" },
            },
          },
          {
            label: "口交",
            target: {
              page: "category",
              attributes: { category: "口交", param: "口交" },
            },
          },
          {
            label: "正太控",
            target: {
              page: "category",
              attributes: { category: "正太控", param: "正太控" },
            },
          },
          {
            label: "年上",
            target: {
              page: "category",
              attributes: { category: "年上", param: "年上" },
            },
          },
          {
            label: "亂倫",
            target: {
              page: "category",
              attributes: { category: "亂倫", param: "亂倫" },
            },
          },
          {
            label: "熟女 / 人妻",
            target: {
              page: "category",
              attributes: { category: "熟女 / 人妻", param: "熟女 / 人妻" },
            },
          },
          {
            label: "同志 BL",
            target: {
              page: "category",
              attributes: { category: "同志 BL", param: "同志 BL" },
            },
          },
          {
            label: "黑肉",
            target: {
              page: "category",
              attributes: { category: "黑肉", param: "黑肉" },
            },
          },
          {
            label: "泳裝",
            target: {
              page: "category",
              attributes: { category: "泳裝", param: "泳裝" },
            },
          },
          {
            label: "手淫",
            target: {
              page: "category",
              attributes: { category: "手淫", param: "手淫" },
            },
          },
          {
            label: "肌肉",
            target: {
              page: "category",
              attributes: { category: "肌肉", param: "肌肉" },
            },
          },
          {
            label: "姐姐 / 妹妹",
            target: {
              page: "category",
              attributes: { category: "姐姐 / 妹妹", param: "姐姐 / 妹妹" },
            },
          },
          {
            label: "捆綁",
            target: {
              page: "category",
              attributes: { category: "捆綁", param: "捆綁" },
            },
          },
          {
            label: "調教",
            target: {
              page: "category",
              attributes: { category: "調教", param: "調教" },
            },
          },
          {
            label: "催眠",
            target: {
              page: "category",
              attributes: { category: "催眠", param: "催眠" },
            },
          },
          {
            label: "露出",
            target: {
              page: "category",
              attributes: { category: "露出", param: "露出" },
            },
          },
          {
            label: "群交",
            target: {
              page: "category",
              attributes: { category: "群交", param: "群交" },
            },
          },
          {
            label: "肛交",
            target: {
              page: "category",
              attributes: { category: "肛交", param: "肛交" },
            },
          },
          {
            label: "獸交",
            target: {
              page: "category",
              attributes: { category: "獸交", param: "獸交" },
            },
          },
        ],
      },
